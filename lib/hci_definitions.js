...
this.BLE = {
	...
	READ_REMOTE_FEATURES    : 0x0016 | self.GRP.BLE_CMDS,
...
this.GATT.TYPE = {
	...
	CHAR_DECLARE          : 0x2803, // Characteristic Declaration

	CHAR_EXT_PROP         : 0x2900, // Characteristic Extended Properties 
	CHAR_DESCRIPTION      : 0x2901, // Characteristic User Description
	CHAR_CLIENT_CONFIG    : 0x2902, // Client Characteristic Configuration 
	CHAR_SRVR_CONFIG      : 0x2903, // Server Characteristic Configuration 
	CHAR_PRESENT_FORMAT   : 0x2904, // Characteristic Presentation Format
	CHAR_AGG_FORMAT       : 0x2905, // Characteristic Aggregate Format
	CHAR_VALID_RANGE      : 0x2906, // Characteristic Valid Range 
	EXT_RPT_REF_DESCR     : 0x2907,
	RPT_REF_DESCR         : 0x2908,
};
...
this.GATT.ERROR = {
	...
	CCC_CFG_ERR                   : 0xFD, // Client Characteristic Configuration Descriptor Improperly Configured
	PRC_IN_PROGRESS               : 0xFE, // Procedure Already in progress
	OUT_OF_RANGE                  : 0xFF  // Attribute value out of range
};
...
this.GATT.OP = {
	...
	REQ_FIND_INFO                 : 0x04,
	RSP_FIND_INFO                 : 0x05,
	REQ_FIND_TYPE_VALUE           : 0x06,
	RSP_FIND_TYPE_VALUE           : 0x07,
	REQ_READ_BY_TYPE              : 0x08,
	RSP_READ_BY_TYPE              : 0x09,
	REQ_READ                      : 0x0A,
	RSP_READ                      : 0x0B,
	REQ_READ_BLOB                 : 0x0C,
	RSP_READ_BLOB                 : 0x0D,
	REQ_READ_MULTI                : 0x0E,
	RSP_READ_MULTI                : 0x0F,
	REQ_READ_BY_GRP_TYPE          : 0x10,
	RSP_READ_BY_GRP_TYPE          : 0x11,
	REQ_WRITE                     : 0x12, // 0001-0010 (write)
	RSP_WRITE                     : 0x13,
	CMD_WRITE                     : 0x52, // changed in V4.0 01001-0010(write cmd)
	REQ_PREPARE_WRITE             : 0x16,
	RSP_PREPARE_WRITE             : 0x17,
	REQ_EXEC_WRITE                : 0x18,
	RSP_EXEC_WRITE                : 0x19,
	HANDLE_VALUE_NOTIF            : 0x1B,
	HANDLE_VALUE_IND              : 0x1D,
	HANDLE_VALUE_CONF             : 0x1E,
	SIGN_CMD_WRITE                : 0xD2, // changed in V4.0 1101-0010 (signed write)  see write cmd above
	OP_CODE_MAX                   : 0x1F
};
